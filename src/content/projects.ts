...
export const projects: Project[] = [
  ...
  },
  {
    ...
    team: [
      ...
      { name: "Mount Werner Water", url: "https://www.mwwsd.org/" },
      { name: "Bertram Drilling" },
  ...
  },
  {
    ...
    team: [
      ...
      { name: "CanAmerica Drilling" },
      { name: "Geothermal Resource Technologies Inc. (GRTI)", url: "https://www.grti.com/" },
      { name: "Bertram Drilling (later phase references)" },
      { name: "Vail Resorts / Breckenridge Ski Resort (snowmelt plaza project)", url: "https://www.vailresorts.com/" },
    ],
    articles: [
      {
  ...
  },
  {
    ...
    status: "Operational",
    summary: "A master scale transformation of the CMU campus utilizing the patented Thermal Highway© architecture. TGEG engineered a high-performance thermal backbone that integrates 22 buildings into a single, cohesive network. This proprietary system demonstrates the power of thermal energy sharing to drastically lower carbon intensity while providing institutional grade utility stability for future expansions",
  ...
  },
  {
    ...
    team: [
      ...
      { name: "Cairn Global" },
      { name: "Snyderville Basin Water Reclamation District", url: "https://www.sbwrd.org/" },
