...
export const whoWeAre = {
  ...
  pillars: [
    ...
    },
    {
      ...
      body: 'Garen Ewbank developed the industry-standard methods for characterizing ground conductivity and diffusivity, later patenting advanced methodologies to improve them. Cary Smith, Mark Smith and Bill O’Donnell brought the ambient one-pipe temperature loop into the modern era through their work at Colorado Mesa University.',
    },
    {
